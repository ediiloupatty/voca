...
# Google Gemini (endpoint OpenAI-compatible resmi Google).
...
# xAI Grok (endpoint OpenAI-compatible resmi xAI).
XAI_API_KEY = os.getenv("XAI_API_KEY")
XAI_BASE_URL = os.getenv("XAI_BASE_URL", "https://api.x.ai/v1")
XAI_MODEL = os.getenv("XAI_MODEL", "grok-4")

# Groq (inference super cepat untuk model open-source; OpenAI-compatible).
...
# Ollama (LLM lokal/offline; endpoint OpenAI-compatible bawaan Ollama).
# Tidak butuh API key sungguhan — cukup placeholder 'ollama' (diisi wizard).
